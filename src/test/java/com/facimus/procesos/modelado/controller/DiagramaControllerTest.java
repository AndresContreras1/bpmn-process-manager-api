...
class DiagramaControllerTest {
    ...
    private static DiagramaResponse diagrama() {
        ...
        return new DiagramaResponse(
                ...
                List.of(new ActividadResponse(5L, "Receive order", "Validate the cart", 100, 80, 3L)),
                List.of(new GatewayResponse(6L, "Payment approved?", TipoGateway.EXCLUSIVO, 260, 80, 3L)),
                List.of(new ArcoResponse(7L, null, null, 5L, 6L, 1L)),
                List.of(new MensajeResponse(8L, "Order placed", "Cart items", 2L, 1L, 10L)),
                List.of(new CorrelacionResponse(9L, "orderId", 8L)));
    }
}
