...
class GrafosDeVersionTest {
    ...
    private final GrafosDeVersion grafos = new GrafosDeVersion(json);
    ...
    void instantanea_seRelee() {
        ...
        GrafoDeVersion grafo = grafos.del(version(json.writeValueAsString(armado.diagrama())));
    ...
    private static VersionProceso version(String definicion) {
        return VersionProceso.builder().numero(1).definicion(definicion).build();
    }
}
